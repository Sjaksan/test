...
4. Click on the button **Create bearer token** and copy the **Token** and use this as Secret Token in step 5.5.
5. Copy the **Tenant URL** and use this as Tenant URL in step 5.5.
